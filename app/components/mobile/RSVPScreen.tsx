      ...
      <div className="relative z-10 w-full flex flex-col items-center justify-center h-full px-6">
        <div className="flex flex-col items-center justify-center transform -translate-y-8">
          ...
          <div className="flex flex-col items-center justify-center">
            <div className="text-[12rem] leading-[0.8] tracking-[0.1em] font-bold font-ophelia text-amber-50 text-center">
          ...
          <button
            ...
            className="px-8 py-3 rounded-full bg-transparent border-2 border-[#0a0a09]/80 text-[#0a0a09]/80 hover:bg-[#e0b553]/30 hover:border-[#e0b553]/80 transition-all duration-300 font-classyvogue font-bold tracking-wider text-lg mt-4 mb-[7.5%]"
          >
            RSVP NOW
          </button>
