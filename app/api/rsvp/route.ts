    ...
    const { data, error } = await resend.emails.send({
        ...
        html: `
            <!DOCTYPE html>
                ...
                <div style="max-width: 100%; margin: 0 auto; padding: 5% 5% 5%;">
                    
                    
                    
                    <!-- Main content card -->
                    <div style="background: white; border-radius: 10px; box-shadow: 0 5px 15px rgba(0,0,0,0.15); border: 1px solid rgba(0,0,0,0.15);">
                        <!-- Full-width image with no padding -->
                        <div style="text-align: center; margin: 0; overflow: hidden; border-radius: 10px 10px 0 0;">
                        ...
                        <p style="font-size: 14px; line-height: 1.7; margin-bottom: 10px;">
                             Hey <span style="font-weight: 500;">${name}</span>,
                        </p>
                                ...
                                <table align="center" style="border-collapse: collapse; font-size: 14px; color: #555; width: auto; margin: 0 auto; text-align: left;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 8px 5px;">
                                            Umwinzii Venue, Harare, Zimbabwe
                                        </td>
                                    </tr>
                                </table>
                            </div>
                    ...
                    <!-- Footer -->
                    <div style="margin-top: 20px; margin-bottom: 20px; text-align: center; color: #aaa; font-size: 12px; padding-top: 20px;">
                        <p style="margin: 0;">
